scriptools.wait(0.4,function()
	...
	scriptools.panToThing(game.room.thingLookup["bookshelf"],1.3,{x=0,y=40},function()
		scriptools.wait(0.4,function()	
			leo.setAnimation("e");	
			scriptools.wait(0.1,function()
		...
		scriptools.wait(1,function()
			scriptools.panToThing(game.room.thingLookup["burnttable"],1.3,{x=0,y=30},function()
				scriptools.wait(1,function()
					game.player.setAnimation("n");
					scriptools.panToThing(game.room.thingLookup["table"],1.1,{x=0,y=60},function()
						scriptools.wait(1,function()
