                        ...
                        scriptools.doOverTime(0.3,function(percent) 
                            ...
                            scriptools.doOverTime(5,function(percent) 
                                ...
                                darkflash(0.8,function() 
                                    ...
                                    creditsThings.zerocreds = TextThing(20,20,0,"Environment art","TitleOption",{r=255,g=255,b=255});
                                    ...
                                    scriptools.wait(creditsdelay,function()
                                        darkflash(0.8,function() 
                                            ...
                                            creditsThings.kylecreds = TextThing(120,20,0,"Evidence art","TitleOption",{r=255,g=255,b=255});
                                                                ...
                                                                darkflash(0.8,function() 
                                                                    ...
                                                                    scriptools.wait(creditsdelay,function()
                                                                        darkflash(0.8,function() 
                                                                            ...
                                                                            creditsThings.soundy = TextThing(120,70,0,"Free sound effects","TitleOption",{r=255,g=255,b=255});
                                                                            creditsThings.push(creditsThings.soundy);
                                                                            creditsThings.soundpeeps = TextThing(120,90,0,"Mike Koenig (soundbible.com)\nJoe DeShon (freesound.org)\nAcclivity (freesound.org)\nRichard Frohlich (freesound.org)","OpenDyslexic",{r=255,g=255,b=255});
                                                                            ...
                                                                            creditsThings.doodle = TextThing(25,160,0,"David Oneacre","OpenDyslexic",{r=255,g=255,b=255});
